...
from medhas.memory.control.prospective import (
    add_intention, check_cues, list_intentions, complete_intention,
)
from medhas.memory.operations.consolidation import run_consolidation
from medhas.memory.operations.forgetting import (
    run_forgetting_sweep, protect_core_memories,
)
from medhas.platform.security import forget as agi_forget
from medhas.platform.export import (
    export_user_memory, export_to_file, import_user_memory,
)
...
from medhas.metamemory.metamemory import knowledge_map, known_unknowns
from medhas.memory.control.scaling import partition_report
...
async def _list_quar(user_id: str):
    from medhas.platform.security import list_quarantined
