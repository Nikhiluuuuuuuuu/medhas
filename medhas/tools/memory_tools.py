...
from medhas.memory.working import update_block, create_memory_block, delete_memory_block, append_to_memory_block, audit_memory_doctor
from medhas.memory.graph import query_point_in_time, query_subgraph
...
MEMORY_TOOLS_DECLARATION: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Letta Omni-Tool: Deletes an unused or obsolete named memory block from medhas.core memory RAM.",
            "parameters": {
                "type": "object",
                "properties": {
