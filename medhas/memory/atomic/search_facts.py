...
from medhas.schemas import FactSearchResult
...
from medhas.memory.atomic.ebbinghaus_decay import calculate_ebbinghaus_retention
        ...
        try:
            ...
            async with DatabasePool.acquire() as conn:
                ...
                if settings.FACT_RERANKER_ENABLED:
                    try:
                        from medhas.memory.atomic.reranker import get_reranker
                        ce = get_reranker()
                        if ce is not None:
                            docs = [
