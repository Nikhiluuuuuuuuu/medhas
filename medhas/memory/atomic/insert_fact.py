...
from medhas.memory.atomic.decision_matrix import decide_fact_action
    ...
    async with measure_latency("memory.atomic.insert_fact"):
        try:
            ...
            async with DatabasePool.acquire() as conn:
                ...
                decision = await decide_fact_action(fact_text, candidates, llm=get_extractor())
            ...
            from medhas.extraction.llm_extract import extract_date_open
