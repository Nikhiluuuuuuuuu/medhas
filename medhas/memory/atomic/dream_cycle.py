...
from medhas.llm.gateway import get_dream_llm
from medhas.memory.atomic.insert_fact import insert_fact
from medhas.memory.working import update_block
    ...
    async with measure_latency("memory.atomic.run_dream_cycle"):
        try:
            async with DatabasePool.acquire() as conn:
                ...
                try:
                    response = await get_dream_llm().chat_completion(messages, temperature=0.2)
                ...
                try:
                    ...
                    if reflections_text:
                        ...
                        pat_resp = await get_dream_llm().chat_completion(pat_msgs, temperature=0.3)
