...
async def run_consolidation(user_id: str, include_dream: bool = True) -> Dict[str, Any]:
    ...
    from medhas.memory.operations.forgetting import protect_core_memories, run_forgetting_sweep
    from medhas.platform.sensory import promote_percepts, sweep_expired
    ...
    async with measure_latency("agi.consolidation.run_consolidation"):
        ...
        if include_dream:
            try:
                from medhas.memory.atomic import run_dream_cycle
