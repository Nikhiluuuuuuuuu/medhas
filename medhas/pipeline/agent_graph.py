...
import medhas.memory.session as session_mem
from medhas.llm.gateway import get_llm
from medhas.tools import MEMORY_TOOLS_DECLARATION, execute_tool_call
...
from medhas.pipeline.metacognition import evaluate_cognitive_mode
from medhas.utils import measure_latency, log_tool, log_error
...
from medhas.engine import engine as agi_engine
...
class UnifiedMemoryEngine:
    ...
    async def agi_context(
        ...
        async with measure_latency("UnifiedMemoryEngine.agi_context"):
            from medhas.memory.working import render_prompt
            ...
            if recall.get("status") == "abstained":
                facts_section = (
                    ...
                    "[No sufficiently confident memory found — do not answer from medhas.memory; "
