...
E18 Abstention: refuse to answer from medhas.memory when evidence is weak (calibrated by
...
from medhas.utils import log_atomic, log_error, log_working, measure_latency
...
def should_abstain(results: Sequence[Any], fok: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    from medhas.metamemory.metamemory import feeling_of_knowing
